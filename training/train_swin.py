"""
training/train_swin.py  –  Training script for Swin-T (Swin Transformer)
"""
...
print(f"Training Swin-T on device: {DEVICE}")
...
def main():
    ...
    model = build_swin_t(num_classes=NUM_CLASSES).to(DEVICE)
    ...
    patience_counter = 0
    checkpoint_path = CHECKPOINT_DIR / "swin_t_best.pth"
